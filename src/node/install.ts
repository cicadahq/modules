...
export function install(version = "latest"): StepOptions {
  const stepFn: StepFn = async () => {
    ...
    await installPackages({
      "apt-get": [{ name: "nodejs", version: version }],
      "pacman": [{ name: "nodejs", version: version }],
      "yum": [{ name: "nodejs", version: version }],
      "dnf": [{ name: "nodejs", version: version }],
      "apk": [{ name: "nodejs", version: version }],
      "pkg": [{ name: "node", version: version }],
      "brew": [{ name: "node", version: version }],
    });
  };
